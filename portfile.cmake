...
set(PATCHES
    0002-devendor-external-dependencies.patch
    0003-only-build-required-projects.patch
    0006-python.pc.patch
    0007-bz2d.patch
    0008-support-newer-osx.patch
)
...
if("deprecated-win7-support" IN_LIST FEATURES)
    list(APPEND PATCHES 0004-restore-support-for-windows-7.patch)
...
if(VCPKG_TARGET_IS_WINDOWS OR VCPKG_TARGET_IS_UWP)
    ...
    if("${WINSDK_VERSION}" VERSION_GREATER_EQUAL "10.0.22000")
        list(APPEND PATCHES "0005-workaround-windows-11-sdk-rc-compiler-error.patch")
    endif()
endif()
...
vcpkg_from_github(
    ...
    SHA512 37066139a0a23a9046fa936576ae0e00bcbb0bc758480c4e4232a906c6af045dcc519b6726d05e2e7686326a2f4bc28d168f5ef3a502c5910446da9d6c92aa40
    HEAD_REF master
    PATCHES ${PATCHES}
)
